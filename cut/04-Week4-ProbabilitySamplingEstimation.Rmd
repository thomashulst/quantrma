...
Although some people find it handy to know the formulas in Table \@ref(tab:distformulas), most people just want to know how to use the distributions without worrying too much about the maths. To that end, R has a function called `dbinom()` that calculates binomial probabilities for us. 
