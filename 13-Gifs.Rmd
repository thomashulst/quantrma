...
```{r corRealgif,echo=T, fig.path='gifs/', message=F, warning=F, eval=F}
library(MASS)
r<-.7
...
if (knitr:::is_latex_output()) {
  ...
  knitr::include_graphics("gifs/regression-1.gif")
}
```
...
```{r sampleUnifExpected,echo=T, fig.path='gifs/', message=F, warning=F, eval=F}
...
```{r, echo=F,eval=T}
knitr::include_graphics(path="gifs/indTtest.gif")
```
...
```{r, echo=F,eval=T}
knitr::include_graphics(path="gifs/indTtestTrue.gif")
```
...
```{r, echo=F,eval=T}
knitr::include_graphics(path="gifs/indTtestN.gif")
```
...
```{r, echo=F,eval=T}
knitr::include_graphics(path="gifs/OneWayNull.gif")
```
...
```{r, echo=F,eval=T}
knitr::include_graphics(path="gifs/FactorialNull.gif")
```
...
```{r normalMovingMean, echo=T, fig.path='gifs/', message=F, warning=F, eval=F}
...
```{r normalMovingSD, echo=T, fig.path='gifs/', message=F, warning=F, eval=F}
