...
How about just taking the absolute value of the difference scores[^Abs]. Remember, the absolute value converts any number to a positive value. Check out the following table:
